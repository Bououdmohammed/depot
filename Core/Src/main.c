...
#include "stdio.h"
#include "diableRGB565.h"
#include "batmanRGB565.h"
#include "missile_diableRGB565.h"
#include "missileRGB565.h"
#include "math.h"
...
osMessageQId myQueueHommePosHandle;
osMessageQId myQueue_Game_OverHandle;
osMessageQId myQueue_I_WINHandle;
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint8_t vitesse_diable = 0; // option réglage de la vitesse du diable pour complexifier le jeu
/* USER CODE END 0 */
...
/* USER CODE BEGIN Header_Task_diable */
/**
...
void Task_diable(void const * argument)
{
  ...
  /* USER CODE END Task_diable */
}

/* USER CODE BEGIN Header_Task_homme */
/**
...
void Task_homme(void const * argument)
{
  ...
  /* USER CODE END Task_homme */
}

/* USER CODE BEGIN Header_Task_virus */
/**
...
void Task_virus(void const * argument)
{
  ...
  /* USER CODE END Task_virus */
}

/* USER CODE BEGIN Header_Task_Game_Over */
/**
